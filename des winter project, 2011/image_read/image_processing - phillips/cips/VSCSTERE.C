&^%$#@!
9
Sat Apr 08 09:00:21 1995
Put in a few comments in s_lengthen_pattern.
!@#$%^&
   ...
   int  argc;
{
   ...
   if(argc != 6){
      printf(
      "\nusage: cstereo width-of-line depth-file-name"
      "\n               stereo-file-name "
...
#ifdef DEBUG_MODE
   width = 60;
   strcpy(special_text, "CUSERSJOUR");
   s_length = strlen(special_text);
...
&^%$#@!
8
Sat Apr 08 08:48:09 1995
Small change, deleted the count=0
statement in s_lengthen_pattern.
!@#$%^&
...
&^%$#@!
7
Sat Apr 08 08:42:39 1995
This has all the pattern_index
index substitutions in it and it works.
!@#$%^&
...
&^%$#@!
6
Wed Apr 05 06:13:38 1995
THis has a quick fix setting index equal to
pattern_index.  I am not sure that this works.
!@#$%^&
...
&^%$#@!
5
Sun Mar 12 11:29:04 1995
This works on the big test cases. Done.
!@#$%^&
...
&^%$#@!
4
Sun Mar 12 10:56:16 1995
This seems to work on the first two or three
dfilexx.txt cases.
!@#$%^&
...
&^%$#@!
2
Sun Mar 12 09:39:45 1995
Finished typing in the code.
No compilation or testing performed yet.
!@#$%^&
        ...
        s_length;
{
   ...
   for(i=0; i<size; i+++){
      pattern[i] = new_index + PATTERN_STAR;
      new_index++;
      if(new_index == s_length)
         new_index = 0;
   }  /* ends loop over i */
