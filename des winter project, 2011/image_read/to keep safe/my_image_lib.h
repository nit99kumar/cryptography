...
/********************************************************
        ...
        Returns a ponter of Image variable type.
        Output Image wil be colored Image.
        
        Input is a bmp_Image variable pointer.
                            ...
                            )                                
{
    ...
    grayscale_image = color_to_grayscale(copy_image(image));
    image = grayscale_image;
    for(i = 0; i < image->height; i++){
        for(j = 0; j < image->header.width; j++){
            if(image->c_matrix[i][j].r < 100)
                fwrite(&ch1, 1, 1, fp);
...
/******************************************************
        ...
        Returns pointer to copy of an Image 
                 ...
                 )
{
    ...
    for(i = 0; i < img->height; i++){
        ...
        image->c_matrix[i] = img->c_matrix[i];
    }
